...
export const RecipeList = () => {
  ...
  const handleSearch = () => {
    if (mealsList) {
      ...
      dispatch(
        setMatchingMeals({
          ingredient: mealsList.ingredient,
          meals: filteredMeals,
        })
      );
    }
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col items-center justify-center">
      <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-3/4 lg:w-2/3">
        <h1 className="text-3xl font-semibold mb-4 text-center text-indigo-600">
        ...
        <div className="flex justify-center mt-4 mb-4">
          <input
            ...
            className="rounded-l-lg p-2 border-t border-b border-l text-gray-800 border-gray-300 bg-white flex-1 mr-0 sm:mr-4 focus:outline-none focus:ring focus:border-indigo-500"
            placeholder="Search Recipes..."
          />
          <button
            onClick={handleSearch}
            className="px-4 py-2 rounded-r-lg bg-indigo-600 text-white font-semibold uppercase border hover:bg-indigo-700 focus:outline-none focus:ring focus:border-indigo-500"
          >
            Search
          </button>
        </div>
